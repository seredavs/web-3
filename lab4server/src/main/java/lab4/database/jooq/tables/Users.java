...
import lab4.database.jooq.tables.Points.PointsPath;
...
public class Users extends TableImpl<UsersRecord> {
    ...
    /**
     * The reference instance of <code>s467432.users</code>
     */
    ...
    /**
     * The column <code>s467432.users.id</code>.
     */
    ...
    /**
     * Create an aliased <code>s467432.users</code> table reference
     */
    ...
    /**
     * Create a <code>s467432.users</code> table reference
     */
    public Users() {
    ...
    private transient PointsPath _points;

    /**
     * Get the implicit to-many join path to the <code>s467432.points</code>
     * table
     */
    public PointsPath points() {
        if (_points == null)
            _points = new PointsPath(this, null, Keys.POINTS__POINTS_USER_ID_FKEY.getInverseKey());
